...
DECLARE @ret int
IF EXISTS(SELECT *
FROM Region r JOIN Student s ON r.RegionID = s.RegionID JOIN Staff sf ON s.StaffID = sf.StaffID
...
INSERT INTO Staff ([StaffName],  RegionID)
VALUES('Hamza Ayrýk',  4);

INSERT INTO Student ([StudentName], RegionID, StaffID)
VALUES('Ali Güzel',  1, 30),
('Osman Yücel',  1, 31),
('Ömer Ýlhan', 1, 32),
('Bekir Gül', 2, 33),
('Ahmet Çiçek', 2, 34),
...
DELETE FROM Staff WHERE StaffID = (SELECT TOP 1 sf.StaffID FROM Student s  RIGHT JOIN Staff sf ON s.StaffID = sf.StaffID
